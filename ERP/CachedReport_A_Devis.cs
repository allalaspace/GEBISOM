...
namespace ERP
{
	...
	public class CachedReport_A_Devis : Component, ICachedReport
	{
		[Browsable(false)]
		...
		{
			Report_A_Devis report_A_Devis = new Report_A_Devis();
			report_A_Devis.Site = Site;
			return report_A_Devis;
		}
