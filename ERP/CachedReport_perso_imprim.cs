...
namespace ERP
{
	...
	public class CachedReport_perso_imprim : Component, ICachedReport
	{
		[Browsable(false)]
		...
		{
			Report_perso_imprim report_perso_imprim = new Report_perso_imprim();
			report_perso_imprim.Site = Site;
			return report_perso_imprim;
		}
