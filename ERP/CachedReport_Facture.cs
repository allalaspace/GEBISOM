...
namespace ERP
{
	...
	public class CachedReport_Facture : Component, ICachedReport
	{
		[Browsable(false)]
		...
		{
			Report_Facture report_Facture = new Report_Facture();
			report_Facture.Site = Site;
			return report_Facture;
		}
